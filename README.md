...
Le [guide](GuideCodeMachine.md) contient les fonctionnalités courantes de l'application et quelques astuces pour mieux utiliser CodeMachine
...
Le type correspond au type de chose modifié dans le commit :
...
- test : Pour toute modification apportée pour des tests
- chore : Tâches de maintenance ou modification des dépendances

La portée correspond à l'étendue du changement ou à la partie touchée
